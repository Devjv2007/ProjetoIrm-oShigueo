        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row md:justify-between items-center gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="flex items-center space-x-4 flex-shrink-0 text-slate-700">
              ...
              <span className="text-sm">
                <span className="ri-time-line px-1" />
                Seg–Sex 9h–18h
              </span>
              <span className="text-sm">
            ...
            <div className="flex space-x-4 flex-shrink-0">
              <a
                href="https://instagram.com/shigueokatojunior"
                target="_blank"
              ...
              <a
                href="https://wa.me/5518981367870?text=Ol%C3%A1%2C+gostaria+de+agendar+uma+visita+para+provar+ternos."
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-white rounded-xl shadow hover:shadow-lg transition"
                aria-label="WhatsApp"
        ...
        <div className="max-w-xs mx-auto flex flex-col items-center gap-3">
          ...
          <div className="flex items-center gap-2 justify-center mt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 bg-white rounded-lg shadow text-slate-700 text-xl hover:shadow-md transition"
              aria-label="Instagram"
            >
